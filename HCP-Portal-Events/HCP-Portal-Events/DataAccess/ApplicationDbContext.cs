    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        private static void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Event>().HasData(
                new Event { Id = 1, Title = "Cardiology CME 2023", Description = "Continuing Medical Education for Cardiology", EventCreatedDate = baseDate.AddDays(30), NoOfAttendees = 120, ImageUrl = "\\images\\events\\OIP (1).jpeg", EventTypeId = 1, Status = "Upcoming", LinkToEvent = "https://zoom.us/cardio-cme-2023", EventSpecialityId = 1 },
                new Event { Id = 2, Title = "Pediatric CME Update", Description = "Latest updates in pediatric medicine", EventCreatedDate = baseDate.AddDays(-15), NoOfAttendees = 80, ImageUrl = "\\images\\events\\OIP (1).webp", EventTypeId = 1, Status = "Previous", LinkToEvent = "", EventSpecialityId = 3 },
                new Event { Id = 3, Title = "Neurology Webinar Series", Description = "Monthly webinars on neurology advancements", EventCreatedDate = baseDate.AddDays(7), NoOfAttendees = 75, ImageUrl = "\\images\\events\\OIP (2).webp", EventTypeId = 2, Status = "Upcoming", LinkToEvent = "https://zoom.us/neuro-webinar", EventSpecialityId = 2 },
                new Event { Id = 4, Title = "Oncology Webinar", Description = "Recent advances in cancer treatment", EventCreatedDate = baseDate.AddDays(45), NoOfAttendees = 90, ImageUrl = "\\images\\events\\OIP.jpeg", EventTypeId = 2, Status = "Upcoming", LinkToEvent = "https://zoom.us/onco-webinar", EventSpecialityId = 4 },
